...
public class BackupActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    private mirero_diaryButton But_backup_export, But_backup_import;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        But_backup_export = (mirero_diaryButton) findViewById(R.id.But_backup_export);
        But_backup_export.setOnClickListener(this);
        But_backup_export.setEnabled(false);

        But_backup_import = (mirero_diaryButton) findViewById(R.id.But_backup_import);
