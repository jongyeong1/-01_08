...
import com.project08team.mirero_diary.backup.obj.BUContactsEntries;
...
import com.project08team.mirero_diary.backup.obj.BUMemoEntries;
...
import static com.project08team.mirero_diary.backup.BackupManager.BACKUP_ZIP_FILE_HEADER;
import static com.project08team.mirero_diary.backup.BackupManager.BACKUP_ZIP_FILE_SUB_FILE_NAME;
...
public class ExportAsyncTask extends AsyncTask<Void, Void, Boolean> {
     ...
     * UI
     */
    //From mirero_diaryApplication Context
                ...
                for (int j = 0; j < diaryEntriesCursor.getCount(); j++) {
                    ...
                    diaryEntriesItemList.add(
                            new BUDiaryEntries(diaryEntriesCursor.getLong(0),
                                    diaryEntriesCursor.getLong(1), diaryEntriesCursor.getLong(2), diaryEntriesCursor.getString(3),
                                    diaryEntriesCursor.getInt(4), diaryEntriesCursor.getInt(5),
                                    diaryEntriesCursor.getInt(6) > 0 ? true : false,
                                    diaryEntriesCursor.getString(8), diaryItemItemList));
