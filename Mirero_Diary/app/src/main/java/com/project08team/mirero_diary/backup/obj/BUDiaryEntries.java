package com.project08team.mirero_diary.backup.obj;
...
public class BUDiaryEntries {
    ...
    public BUDiaryEntries(long diary_entries_id, long diary_entries_time_from, long diary_entries_time_to, String diary_entries_title,
