...
public class UpdateDiaryTask extends AsyncTask<Long, Void, Integer> {
    ...
    public UpdateDiaryTask(Context context, long time_from, long time_to, String title,
    ...
    protected Integer doInBackground(Long... params) {
        ...
        try {
            ...
            //Update Diary
            dbManager.updateDiary(diaryId, time_from, title, moodPosition, weatherPosition, location, attachment);
