...
import com.project08team.mirero_diary.shared.gui.mirero_diaryButton;
import com.yalantis.ucrop.UCrop;

import java.io.File;

import static android.app.Activity.RESULT_OK;
import static com.project08team.mirero_diary.shared.PermissionHelper.REQUEST_WRITE_ES_PERMISSION;
...
public class TopicDetailDialogFragment extends DialogFragment implements View.OnClickListener,
    ...
    private mirero_diaryButton But_topic_detail_default_bg;
    private Spinner SP_topic_detail_type;
    private mirero_diaryButton But_topic_detail_ok, But_topic_detail_cancel;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        But_topic_detail_ok = (mirero_diaryButton) rootView.findViewById(R.id.But_topic_detail_ok);
        But_topic_detail_ok.setOnClickListener(this);
        But_topic_detail_cancel = (mirero_diaryButton) rootView.findViewById(R.id.But_topic_detail_cancel);
        ...
        if (isEditMode) {
            ...
            But_topic_detail_default_bg = (mirero_diaryButton) rootView.findViewById(R.id.But_topic_detail_default_bg);
