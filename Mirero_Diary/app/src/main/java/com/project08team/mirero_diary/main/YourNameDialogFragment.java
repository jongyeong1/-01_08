...
public class YourNameDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    private mirero_diaryButton But_your_name_ok, But_your_name_cancel;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        But_your_name_ok = (mirero_diaryButton) rootView.findViewById(R.id.But_your_name_ok);
        But_your_name_ok.setOnClickListener(this);
        But_your_name_cancel = (mirero_diaryButton) rootView.findViewById(R.id.But_your_name_cancel);
