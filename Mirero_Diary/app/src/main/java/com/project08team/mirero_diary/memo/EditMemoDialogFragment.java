...
public class EditMemoDialogFragment extends DialogFragment implements View.OnClickListener {
     ...
     * UI
     */
    private mirero_diaryButton But_edit_memo_ok, But_edit_memo_cancel;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        But_edit_memo_ok = (mirero_diaryButton) rootView.findViewById(R.id.But_edit_memo_ok);
        But_edit_memo_cancel = (mirero_diaryButton) rootView.findViewById(R.id.But_edit_memo_cancel);
