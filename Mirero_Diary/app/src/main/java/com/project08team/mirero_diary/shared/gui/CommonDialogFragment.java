...
public abstract class CommonDialogFragment extends DialogFragment implements View.OnClickListener {
     ...
     * UI
     */
    protected mirero_diaryButton But_common_ok, But_common_cancel;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        But_common_ok = (mirero_diaryButton) rootView.findViewById(R.id.But_common_ok);
        But_common_cancel = (mirero_diaryButton) rootView.findViewById(R.id.But_common_cancel);
