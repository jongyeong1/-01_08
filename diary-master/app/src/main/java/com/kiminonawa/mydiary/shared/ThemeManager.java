...
public class ThemeManager {
    ...
    public final static int sample1 = 0;
    public final static int sample2 = 1;
    ...
    //Default color is sample1
    public int currentTheme = sample1;
    ...
    public String getThemeUserName(Context context) {
        ...
        switch (currentTheme) {
            case sample1:
                userName = context.getString(R.string.profile_username_1);
                break;
            case sample2:
                userName = context.getString(R.string.profile_username_2);
                break;
            default:
